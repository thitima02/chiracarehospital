...
$sql = "SELECT mf.patient_id, pi.full_name, pm.disease_type, mf.blood_sugar_level, mf.general_symptoms, mf.vital_signs, mf.reason_for_missed_treatment, mf.form_submission_date, mf.newupdate,mf.user_fullname, mf.id_user_info
