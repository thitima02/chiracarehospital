    ...
    try {
        if (isset($_GET['patient_id'])) {
            ...
            patient_image, 
            id_patient_address, 
            id_patient_medical_information,
            (SELECT date_create FROM patient_medical_information WHERE patient_id = patient_information.patient_id) AS date_create,
            (SELECT last_update FROM patient_medical_information WHERE patient_id = patient_information.patient_id) AS last_update
