...
try {
    ...
    $stmt = $conn->prepare("SELECT id, full_name, id_card, birth_date, phone_number, emergency_phone, rank, department, marital_status, current_status FROM patient_information");
    $stmt->execute();
